...
//// friend.)
//println(3 - math.pow(math.sqrt(3), 2))                    //> 4.440892098500626E-16
//
...
//// import util.Random
//BigInt.probablePrime(100, util.Random)                //> res3: scala.math.BigInt = 912013777957722342425952556723
//
...
//BigInt.probablePrime(100, util.Random).toString(36)   //> res4: String = 2w2bxtp6lz08l502sg9h
//
